...
knitr::include_graphics("../docs/assets/manhattan_atlas_4038.png")
```
...
Manhattan Plot  
```{r, out.height="100%", out.width="100%", echo=FALSE}
knitr::include_graphics("../docs/assets/scz_EAS.png")
```
...
Manhattan Plot  
```{r, out.height="100%", out.width="100%", echo=FALSE}
knitr::include_graphics("../docs/assets/manhattan_atlas_4210.png")
```
