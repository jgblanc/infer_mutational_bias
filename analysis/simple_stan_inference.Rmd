...
$$P(W|\beta, N, \mu, x) = \frac{P(x| \beta, N, \mu, W) P(W)}{P(x)} \propto P(x| \beta, N, \mu, W) P(W)$$  
...
We can simulate our data the same way we did for just evolutionary status:  
```{r}
# Constant parameters 
N <- 100000
mu <- 10^-9 
