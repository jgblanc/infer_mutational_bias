...
#gwas_data <- fread("~/infer_mutational_bias/data/GWAS_ATLAS/breastcancer_3659.txt")
...
# Re-arrange columns
data <- data[,c("SNP","EA" ,"NEA", "CHR" ,"BP","OR" ,"SE" ,"P", "EAF", "MAF", "RAF", "RISK_ALLELE")]
